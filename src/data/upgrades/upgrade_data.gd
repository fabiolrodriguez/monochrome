...
enum Stat { DAMAGE, FIRE_RATE, MOVEMENT_SPEED, MAX_HEALTH, PROJECTILE_SPEED, MULTISHOT, PIERCING, RICOCHET, ARMOR, REGENERATION, BARRIER, CRITICAL_CHANCE, CRITICAL_DAMAGE }
